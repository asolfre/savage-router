...
class LayerTag extends TagBase {

	private static final String DEBUG_TAG = LayerTag.class.getSimpleName();

	private final TagBase mParent;

	protected LayerTag(final TagBase pParent) {
		super(pParent);
		mParent = pParent;
	}
	...
	public void parseText(final String pText) {
		final int layer = Integer.parseInt(pText);
		mParent.setLayer(layer);
	}
